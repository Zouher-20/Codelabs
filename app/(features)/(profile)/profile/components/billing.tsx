...
const Billing = ({ user }: { user: userType }) => {
    return (
        <div className="flex gap-4 max-md:flex-col">
            ...
            <div className="flex flex-col justify-center h-fit gap-4 rounded-3xl border-2 border-base-100 p-4">
                ...
                <Link href={`/plans/${user.PlanSubscription.planId}`} className="btn btn-secondary self-end">
                    See Our Plans
                </Link>
            </div>
        </div>
